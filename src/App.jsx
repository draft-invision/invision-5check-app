...
import footerLinePng from "./assets/footer-line.png";
import darumaPng from "./assets/daruma.png";

import kumo2Png from "./assets/kumo2.png";
...
function FooterBar(){
  return <div style={{width:"100%",lineHeight:0,fontSize:0}}>
    <img src={footerLinePng} alt="" style={{width:"100%",display:"block",margin:0,padding:0}}/>
